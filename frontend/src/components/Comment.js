...
class Comment extends React.Component {
    ...
    componentDidMount = () => {
        const commentVotes = this.props.commentVotes;
    ...
    handleUpVote = () => {
        this.createCommentVote({
            ...
            if (e.graphQLErrors) {
                ...
                if (message.includes("CommentVote exists")) {
                    const commentVoteId = message.replace('CommentVote exists: ', '');
                    this.deleteCommentVote({
                        variables: {
                            id: commentVoteId,
                        }
                    })
                } else if (message.includes("Change commentVote")) {
                    const commentVoteId = message.replace('Change commentVote: ', '');
                    this.deleteCommentVote({
                        variables: {
                            id: commentVoteId,
                        }
    ...
    handleDownVote = () => {
        this.createCommentVote({
            ...
            if (e.graphQLErrors) {
                ...
                if (message.includes("CommentVote exists")) {
                    const commentId = message.replace('CommentVote exists: ', '');
                    this.deleteCommentVote({
                        variables: {
                            id: commentId,
                        }
                    ...
                    const commentId = message.replace('Change commentVote: ', '');
                    this.deleteCommentVote({
                        variables: {
                            id: commentId,
                        }
                ...
                <div className='d-flex justify-content-between'>
                    <div className='d-flex'>
                        <small className="text-muted mr-4">
                            <div>
                                <svg onClick={this.handleUpVote} version="1.1" width="50" height="24" viewBox="0 0 24 24" >
                                ...
                                <svg onClick={this.handleDownVote} version="1.1" width="50" height="24" viewBox="0 0 24 24">
