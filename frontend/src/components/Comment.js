        ...
        <div className='d-flex justify-content-between' style={{padding:"30px"}}>
          <div className='d-flex'>
              <div style={{display:"flex",flexDirection:"column",padding:"5px"}}>
                <div>
                  <svg onClick={this.handleUpVote} style={{fill:this.state.hasUpVotedBefore ? "green" : "dimgrey"}} version="1.1" width="50" height="24" viewBox="0 0 24 24" >
                ...
                <div>
                  <svg onClick={this.handleDownVote} style={{fill:this.state.hasDownVotedBefore ? "red" : "dimgrey"}} version="1.1" width="50" height="24" viewBox="0 0 24 24">
