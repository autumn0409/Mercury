      ...
      <div>
        <div className="list-group-item list-group-item-action" style={{ width: "100%" }}>
          ...
          <small className="text-muted">
            <div>
              <svg onClick={this.handleLike} style={{fill:this.state.likeColor}} className="like" version="1.1" width="50" height="24" viewBox="0 0 24 24" >
              ...
              {this.state.likeNum}
              <svg onClick={this.handleDislike} style={{fill:this.state.dislikeColor}} className="dislike" version="1.1" width="50" height="24" viewBox="0 0 24 24">
