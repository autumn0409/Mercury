            ...
            return (
              <React.Fragment>
                <Jumbotron>
                  ...
                  <hr className="my-1" />
                  <p className="lead">
                    <svg className="like" style={{fill:this.state.likeColor}} version="1.1" width="50" height="24" viewBox="0 0 24 24" onClick={this.handleLike}>
                    ...
                    {likeNum}
                    <svg className="dislike" style={{fill:this.state.dislikeColor}} version="1.1" width="50" height="24" viewBox="0 0 24 24" onClick={this.handleDislike}>
